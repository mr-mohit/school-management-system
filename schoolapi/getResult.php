...
if($con)
{
     ...
     function test_input($data) {
				...
				$sql="SELECT  DISTINCT class_test_master.CLASS_TEST_ID,class_test_master.TEST_NAME, class_test_master.TEST_TYPE,class_test_master.SUBJECT_ID,subject.SUBJECT_NAME,class_test_table.MARKS_OBTAINED,
